<?php return [
    ...
    'settings' => [
        ...
        'comment_enabled_front_playmobile' => 'Can frontend users log in with PlayMobile ?',
        'comment_enabled_back_playmobile' => 'Can administrators log into the backend with PlayMobile ?',
